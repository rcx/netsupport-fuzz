...
/* 318 */
struct __declspec(align(4)) ReplayerSub_t
{
	ReplayerSS_t *replayerSS;
};
...
struct vt_ReplayParser_t
{
  ...
  int (__thiscall *vf1)(ReplayParser_t *pthis);
  int (__thiscall *vf2)(ReplayParser_t *pthis);
  int (__thiscall *vf3)(ReplayParser_t *pthis);
  int (__thiscall *vf4)(ReplayParser_t *pthis);
  int (__thiscall *vf5)(ReplayParser_t *pthis);
};
...
{
  void **vmt;
  ReplayerSub_t sub; // ReplayerSS_t *replayerSS;
  char pad[1504];
  DWORD mystery000;
  DWORD mystery001;
  DWORD mystery002;
...
{
  DWORD pad[2];
  ReplayParserS2_t *pReplayParserS2;
};
